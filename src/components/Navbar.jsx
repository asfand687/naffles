...
const Navbar = () => {
  return (
    <nav className="bg-[#FBEB3B] text-black rounded-xl p-4">
      <article className="flex flex-col lg:flex-row items-center py-2 px-4 space-y-4 lg:space-y-0 justify-between">
        <div className="flex flex-col lg:space-x-8 items-center space-y-4 lg:space-y-0">
          <img className="w-16" src={Logo} alt="Naffles" />
          <div className="flex space-x-10 px-8 text-2xl">
